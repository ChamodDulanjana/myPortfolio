...
const StyledBtn = ({text, Icon}: StyledBtnProps) => {
  return (
    <button className="outline-none cursor-pointer py-3 px-6 text-[17px] rounded-full overflow-hidden bg-transparent text-white relative group border border-gray-300 shadow-md">   
